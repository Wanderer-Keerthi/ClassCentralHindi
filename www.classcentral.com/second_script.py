...
with open('/Users/ihtre/OneDrive/Desktop/classCentral1/www.classcentral.com/university/purdue.html', 'r', encoding='utf-8') as f:
    html = f.read()
...
with open('purdue_hi.html', 'w', encoding='utf-8') as f:
    f.write(str(soup))
